...
<div x-data="{
        open: false,
        search: '',
        selectedId: @entagle($property).live,
        options: @js($options),
        get filteredOptions() {
...
>
    <div class="relative mt-2">
        <button
            @click="open = !open"
            type="button"
            class="relative cursor-pointer w-full text-normal border-gray-300 rounded-md bg-white py-2 pl-3 pr-10
                text-left shadow-sm ring-1 ring-inset ring-gray-300 focus:border-sky-500 focus:ring-sky-500"
        >
